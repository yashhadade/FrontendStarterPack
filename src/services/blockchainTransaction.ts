...
const getBlockchainTransactions = (query: GetBlockchainTransactionsQuery) => {
    return server.get(`blockchainTransaction/getTransaction`,{params: query})
    .then(res=>{
        return res.data
    })
    .catch(err=>{
...
const getTransactionToSign = (data: GetTransactionToSignData) => {
    return server.post(`blockchainTransaction/getTransactionToSign`, data)
    .then(res=>{
        return res.data
    })
    .catch(err=>{
...
const confirmTransaction = (data: ConfirmTransactionData) => {
    return server.post(`blockchainTransaction/confirmTransaction`, data)
    .then(res=>{
        return res.data
    })
}
...
const retryTransaction = (transactionId: string) => {
    return server.post(`blockchainTransaction/retryblockchainTransaction/${transactionId}`)
    .then(res=>{
        return res.data
    })
    .catch(err=>{

...
const BlockchainTransactionDetails = () => {
      ...
      return (
        <div className="mt-2 mb-2 flex items-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3">
          ...
          <p className="text-sm font-semibold text-blue-800">
            This transaction is ready to execute, but waiting for lower nonce transaction to execute
            first.
          </p>
        </div>
      );
  ...
  useEffect(() => {
    ...
    const tick = async () => {
      ...
      const stillExecuting = tx?.status === 'EXECUTING';
            ...
            <div className="flex flex-col gap-4 flex-1">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <h2 className="font-semibold text-foreground leading-4">
                    Multi-Sig Transaction Review
                  </h2>
          ...
          <div className="glass-card p-6 space-y-5">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Approval progress and signer breakdown.
              </p>
            </div>
